...
import { academic_bodies, des } from "../../@shared/repositories/academic_bodies/repository.ts";
import { prodep_areas } from "../../@shared/repositories/prodep/repository.ts";
import { validity, campus, grade } from "../../@shared/search-criteria/search-criteria.ts";
...
export default class AcademicBodyManagementPage extends Vue {
  ...
  fields = [
    ...
    {key: 'last_evaluation.grade_name', label: 'Grado de consolidación', sortable: true, editable: true, class: 'vw-5'},
